        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:p-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            {approaches.map((item, index) => (
              <div key={index} className="flex gap-5 card hover:-translate-y-1 transition-transform reveal">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary-50 flex items-center justify-center border border-primary-100">
